            ...
            <div class="span12">
                <div class="widget no-margin">
                    <div class="widget-header">
                        <div class="title">
                            Batch List of 9th Admission<a data-original-title="" id="notifications">s</a>
                        </div>
                    ...
                    <div class="widget-body">
                                ...
                                <tbody>
                                    ...
                                    if($info!= false)
                                    {
                                        ...
                                        foreach($Inst_Cd = $info as $key=>$vals):
                                            ...
                                            <button type="button" class="btn btn-info" value="'.$vals['Batch_ID'].'" onclick="Revenue_list_batchwise_9thAdm('.$vals['Batch_ID'].')">Download Revenue Form</button>
                                            ';
                                            /*if($vals['flag']==0){
                        ...
                        <div class="control-group">
                            <div class="controls controls-row">
                                <a href="<?php echo base_url(); ?>Admission_9th_reg/forwarding_pdf" class="link offset5 blink_text" style="font-size: x-large;float:left;" target="_blank" >Download Forwarding letter</a></br>
                                <a href="<?php echo base_url(); ?>Admission_9th_reg/financeReoprt" target="_blank"  class="link offset5 blink_text" style="font-size: x-large;display: block;margin-left: 40% !important;" >Download Finance Forwarding Letter. </a> 
