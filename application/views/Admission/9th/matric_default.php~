    ...
    <div class="span12">
        <div class="widget">
            <div class="widget-header">
                <div class="title">
                    Exam 9th <?php if(Session == "1"){echo "Annual";} else echo "Supply" ?>, <?php
                    echo Year;
                    ?>:
                </div>
            </div>
            <div class="widget-body">
                ...
                <form enctype="multipart/form-data" id="options" name="options" method="post" action="" >
                    <table>
                        <tr>
                            <td ><label class="welcome_note myEngheading" >Exam 9th <?php if(Session == "1"){echo "Annual";} else echo "Supply" ?>, <?php
                                    echo Year;
                                ?></label></td>
                        ...
                        <tr>
                            <td width="50%">
                                <label class=myEngParagraph >  Note:-Last Date of Online Admissions and Submission of Hard Copy for Matric <?php if(Session == "1"){echo "Annual";} else echo "Supply" ?> Examination with (Single fee) is <?php echo SingleDateFee9th ?>.</label>  
                            </td>
                            <td width="50%"  >
                                <label class=myUrduParagraph>داخلہ فارسنگل فیس کے ساتھ آن لائن کرنے اور بھجوانے کی آخری تاریخ     <label class="label"> <?php echo SingleDateFee9th; ?> </label>  ہے                                         </label>
                            </td>
                        </tr>
                    </table>
                    ...
                    <div style="vertical-align:bottom;margin-top: 20px; font-weight: bold;">
                        <input type="button" value="Next" id="proceed9th" name="proceed9th" class="jbtn jmedium jblack">
                ...
                <div class="info"  style="position:relative;margin:0;padding:0;overflow:hidden;">
                    ...
                    <div align="center" >
                        <table>
                        <tr>
                            <th><b style="margin-left: 2px;">Form No. : <img src="assets/css_matric/img/required.png" alt="Required Field." class="tooltip" title="Required Field." /></b></th>
                        ...
                        <input type="button" value="Download" name="btndwnForm9th" id="btndwnForm9th" class="jbtn jmedium jblack" />
                        </span> </td>
                        </tr>
                        </table>
