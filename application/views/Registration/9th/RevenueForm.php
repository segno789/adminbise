...
<table border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
        <td colspan="8"><div style="font-size:16px;font-weight:bold;text-align:center;">REVENUE FORM SHOWING DETAILS OF ENROLMENT <br />
                9th Class (SESSION <?php echo sessReg ?>)
            </div> 
        </td>
    </tr>
    <tr>
...
<table width="100%" border="0"  cellpadding="0" class="table2">
    <tr>
        <td style="    width: 290px;">
            <table>
                <tr>
                    <td style="display: inline-block"><strong>Total No. Of Candidates: <?php  echo $data['batch_info'][0]["COUNT"];?></strong></td>
                </tr>
                <tr>
                    <td style="display: inline-block"><strong>Amount Of Enrolment Fee: <?php echo  $data['batch_info'][0]["Total_RegistrationFee"];?></strong></td>
                </tr>
                <tr>
                    <td style="display: inline-block"><strong>Amount Of Processing Fee: <?php echo  $data['batch_info'][0]["Total_ProcessingFee"];?></strong></td>
                </tr>
                  <tr>
                    <td><strong>Amount Of Late + Token Enrolment Fee: <?php echo  $data['batch_info'][0]["Total_LateRegistrationFee"];?></strong></td>
                </tr>
                <tr>
                    <td><strong>Total Amount: <?php echo  $data['batch_info'][0]["Amount"];?></strong></td>
                </tr>
        ...
        <td>
            <table>
                <tr> 
                    <td  style="display: inline-block; "><strong>Challan No: <?php echo $data['batch_info'][0]["Challan_No"];?></strong> </td>
                </tr>
                <tr>

                    <td style="display: inline-block;"><strong>Deposit Date:</strong> ____/____/______</td>
                </tr>
                <tr>

                    <td style="display: inline-block;"><strong>HBL Branch Name:</strong> ________________________</td>
                </tr>
                <tr> 
  ...
  //DebugBreak();
    ...
    foreach ($data['stdinfo'] as $key=>$vals) {
        ...
        <tr>
            ...
            <td class="td"><strong><?php echo $vals->FormNo;?></strong></td>
