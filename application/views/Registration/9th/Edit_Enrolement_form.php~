            ...
            <div class="span12">
                <div class="widget">
                    ...
                    <div class="widget-body">
                        ...
                        <form class="form-horizontal no-margin" id="myform" name="myform" action="<?php  echo base_url(); ?>/index.php/Registration/NewEnrolment_update" method="post" enctype="multipart/form-data">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls controls-row">
                                    ...
                                    <select id="sub8"  name="sub8" class="span3 dropdown">
                                        <option value="<?php if($isReAdm != 1) { echo $data[0]['sub8'];} else echo'4'; ?>" selected="selected"><?php
                                                             if($isReAdm != 1) {echo array_search($data[0]['sub8'],$subarray);} else echo"Pakistan Studies";      
                                                               ?></option></select>
                                </div>
                                ...
                                <div class="controls controls-row"> 
                                    <select id="sub4" class="span3 dropdown" name="sub4" selected="selected">
                                    <?php  if($isReAdm != 1)
                                    { echo "";} ?>
                                    ...
                                    <select id="sub5"  name="sub5" class="span3 dropdown" selected="selected">
                                ...
                                <div class="controls controls-row">    
                                    <select id="sub6" class="span3 dropdown" name="sub6" selected="selected">
