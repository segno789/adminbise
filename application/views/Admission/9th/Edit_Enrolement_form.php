                        ...
                        <form class="form-horizontal no-margin" action="<?php  echo base_url(); ?>/index.php/Admission_9th_reg/NewEnrolment_update" method="post" enctype="multipart/form-data">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls controls-row">
                                    ...
                                    <?php  $picpath =  DIRPATH9th.'/'.$Inst_Id.'/'.$data[0]['PicPath'];
                                                       // echo $picpath;
                                                        $type = pathinfo($picpath, PATHINFO_EXTENSION);
                                                        $data[0]['PicPath'] = 'data:image/' . $type . ';base64,' . base64_encode(file_get_contents($picpath));?>
                                    <img id="previewImg" style="width:80px; height: 80px;" class="span2" src="<?php  if($isReAdm==1) {} else{echo $data[0]['PicPath']; } ?>" alt="Candidate Image">
                                </div>
                            </div>
                            <div class="control-group">
