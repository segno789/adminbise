                    ...
                    <div class="widget-body">
                                ...
                                <tbody>
                                    ...
                                    if($info!= false)
                                    {
                                        ...
                                        foreach($Inst_Cd = $info as $key=>$vals):
                                            ...
                                            <button type="button" class="btn btn-info" value="'.$vals['Batch_ID'].'" onclick="cutlist('.$vals['Batch_ID'].')">Cutlist</button>
                        ...
                        <div class="control-group">
                            <div class="controls controls-row">
                                <a href="<?php echo base_url(); ?>Admission_matric/forwarding_pdf" class="link offset5 blink_text" style="font-size: x-large;" target="_blank" >Download Forwarding Letter. </a>
                                <a href="<?php echo base_url(); ?>Admission_matric/financeReoprt" target="_blank"  class="link offset5 blink_text" style="font-size: x-large;display: block;margin-left: 40% !important;" >Download Finance Forwarding Letter. </a> 
                            </div>
                        </div>
